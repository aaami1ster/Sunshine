 ...
 */
package com.example.abdalla.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: location table invalid data",cursor, testValues);
        assertFalse("Error: table contains more than one record", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: weather table empty cursor returned", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: weather table invalid data", cursor, testValues);
        // Finally, close the cursor and database
        cursor.close();
        db.close();
    }
